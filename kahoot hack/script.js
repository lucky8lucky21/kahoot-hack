...
console.clear();
console.log('%cScript created by jiho Lee', "color:#ff66ff");
console.log('Cheat is under GNU General Public License v3.0.\nGithub repo: https://github.com/lukejiholuke3/Kahoot-hack');
            ...
            .then((r) => {
                if (!r.ok) {
                    fetch(`https://kahoot.it/rest/challenges/${userInput}/answers`)
                        .then((res) => {
                            if (!res.ok) {
                                console.log(`%cCan't find the quiz by id: ${userInput}! Try again!`, "color:red");
                                alert(`Can't find the quiz by id: ${userInput}! Try again!`);
                        ...
                        .then((res) => {
                            if (res.answers[1].quizId) {
                                console.log(`%cI found the answers for you!`, "color:#63ff68");
                                alert(`I found the answers for you!`);
